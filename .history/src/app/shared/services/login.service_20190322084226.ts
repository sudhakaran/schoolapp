...
export class LoginService {
  ...
  public login(userDetails): Observable<any> {
      ...
      const userTokenID = 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJBTkFORCIsInNjb3BlcyI6W3siYXV0aG9yaXR5IjoiUk9MRV9BRE1JTiJ9XSwiaXNzIjoiaHR0cDovL3BhcnNjaG9vbGFwcC5jby5pbiIsImlhdCI6MTU1MzIyMzk5OCwiZXhwIjoxNTUzMjQxOTk4fQ.u-Dwg7tS_2wlquInDNrileiNY5dYmJtQNGjrFOHLh6I';

      localStorage.setItem('currentUSer', userTokenID);
